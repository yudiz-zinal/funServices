          ...
          <Col md={8}>
            <div className="profile-pic d-flex align-items-center justify-content-center mx-auto mb-3 mb-md-4 mb-xl-5 position-relative">
              ...
              <div className="edit-pic position-absolute rounded-circle overflow-hidden d-flex align-items-center justify-content-center">
                <input type="file" className="position-absolute w-100 h-100 opacity-0" />
            ...
            <div class="from-group">
              ...
              <input type="text" class="form-control input-field" id="name" placeholder="Please enter the Name" />
            </div>
            <div class="from-group">
              <label for="email" class="form-label" >
                Email id
              </label>
              <input type="text" class="form-control input-field" id="email" placeholder="Please enter the email id" />
            </div>
            <div class="from-group">
              <label for="mobileNumber" class="form-label" >
                Mobile Number
              </label>
              <input type="text" class="form-control input-field" id="mobileNumber" placeholder="Please enter the Mobile Number" />
            </div>
