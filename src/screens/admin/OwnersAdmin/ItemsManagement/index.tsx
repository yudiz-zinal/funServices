    ...
    <section className="management-section mb-3 mb-md-4 pb-1">
      <div className="title d-flex flex-column flex-lg-row justify-content-between align-items-lg-center pb-3">
        ...
        <div className="d-flex flex-wrap flex-md-nowrap align-items-center">
          ...
          <Button className="theme-btn small-btn dark-btn ms-sm-2">Import CSV</Button>
          <NavLink to="/items-management/create" className="theme-btn small-btn ms-2">Add Items</NavLink>
        </div>
      </div>
          ...
          <tr>
            ...
            <th>
              <div class="d-flex align-items-center justify-content-center">
                Item Name <Button className="data-sort flex-shrink-0" variant="link"><img src={sortIcon} alt="sort" /></Button>
              </div>
            </th>
            <th>
              <div class="d-flex align-items-center justify-content-center">
                Item Code <Button className="data-sort flex-shrink-0" variant="link"><img src={sortIcon} alt="sort" /></Button>
              </div>
            </th>
            <th>
              <div class="d-flex align-items-center justify-content-center">
                School’s Cost <Button className="data-sort flex-shrink-0" variant="link"><img src={sortIcon} alt="sort" /></Button>
              </div>
            </th>
            <th>Action</th>
          </tr>
